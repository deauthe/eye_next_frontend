...
const Signup = (props: Props) => {
	...
	return (
		<div className="flex flex-col w-full min-h-screen h-fit bg-base-100">
			<div className="md:w-2/3 rounded-3xl flex flex-col bg-base-300 mx-auto md:py-10 gap-10">
				<div className="mx-auto w-2/3 flex flex-col gap-3">
					...
					<Link
						href="auth/login"
						className="du-btn du-btn-block du-bordered p-0 rounded-full px-0"
					>
						Sign In Instead
					</Link>
				</div>
				{/* signup/ login option  */}
				<div className="w-5/6 md:grid md:grid-cols-2 flex flex-col items-center md:gap-10 mx-auto text-secondary-content">
					<Button
